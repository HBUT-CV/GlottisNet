...
from mmdet.utils.boxam_utils import (BoxAMDetectorVisualizer,
...
def parse_args():
    ...
    parser.add_argument(
        ...
        # default=['backbone.stage4[0]'],
        # default=['neck.bottom_up_blocks[0].final_conv'],
        default=['neck.downsamples[0]'],
        nargs='+',
        type=str,

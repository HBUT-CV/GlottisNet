...
pretrained = 'https://download.openmmlab.com/mmclassification/v0/mobilenet_v3/mobilenet-v3-small-050_3rdparty_in1k_20221114-e0b86be1.pth'
...
model = dict(
    ...
    neck=dict(
        type='FPN',
        in_channels=[16, 24, 48], #[16, 32, 96, 1280],
        out_channels=16,
        start_level=0, # 1,
